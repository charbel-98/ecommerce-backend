...
public class ProductController {
	...
	@Operation(summary = "Create a new product with AI-generated variants", description = "Creates a new product with color variants generated by AI from a single image. Admin only.", security = @SecurityRequirement(name = "bearerAuth"))
	public ResponseEntity<ProductResponse> createProduct(@RequestParam("image") MultipartFile image,
			@RequestParam("name") String name, @RequestParam("description") String description,
			@RequestParam("basePrice") BigDecimal basePrice, @RequestParam("brandId") UUID brandId,
			@RequestParam("categoryId") UUID categoryId, @RequestParam("gender") String gender,
		...
		try {
			ProductResponse response = productService.createProductWithAIVariants(image, name, description, basePrice,
					brandId, categoryId, gender, variantsJson, metadataJson);
